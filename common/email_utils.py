...
class EmailUtils:
    ...
    def send_mail(self):
        ...
        try:
            smtp.sendmail(self.smtp_sender, self.smtp_receiver.split(','),
...
if __name__=='__main__':
    report_path='D:\\P5_PO_UI_Test_Framework_01\\reports\\禅道自动化测试报告V1.5'
    EmailUtils('禅道自动化测试报告', '禅道自动化测试报告',report_path).zip_send_mail()
